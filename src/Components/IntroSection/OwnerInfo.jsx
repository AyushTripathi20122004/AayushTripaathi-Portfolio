...
const OwnerInfo = () => {
  ...
  return (
    <div className={`${data.theme=='dark'? 'bg-transparent border-zinc-700/50':'bg-white '} lg:absolute md:absolute bottom-10 left-4   rounded-xl backdrop-blur-xs p-6 border flex flex-col gap-1.5 leading-tight text-sm font-sans `}>
